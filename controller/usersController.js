...
const insertUser = async(req,res)=>{
    ...
    //     await insertUserDB(firstName,lastName,userAge,gender,role,email,password,profile, hashedP)
    // })
...
const updateUser = async(req,res)=>{
    let {firstName,lastName,userAge,gender,role,email,password,profile} = req.body
    let users = await getPeerDB(req.params.id)
    // console.log(peer);
   firstName?firstName=firstName: firstName = users.lastName 
   ...
   profile ?profile=profile: profile = users.profile
